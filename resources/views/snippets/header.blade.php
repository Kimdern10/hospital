...
@endif
                    ...
                    @if(Auth::check())
                        @if(Auth::user()->role_as == 1)
                            ...
                            <li class="nav-item d-md-none">
                                <a class="nav-link" href="{{ route('logout')}}" onclick="event.preventDefault(); document.getElementById('mobile-logout-form').submit();">Logout</a>
    ...
    <input class="form-control mr-sm-2" 
           type="search" 
           name="search" 
           value="{{ request('search') }}" {{-- keep search term after submit --}}
